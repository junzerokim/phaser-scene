...
export default class Mob extends Phaser.Physics.Arcade.Sprite {
  constructor(scene, x, y, texture, animKey, initHp, dropRate) {
    ...
    if (texture === 'mob2') this.setBodySize(24, 32);
    if (texture === 'mob3') this.setBodySize(24, 32);
    if (texture === 'mob4') this.setBodySize(24, 32);
    if (texture === 'lion') this.setBodySize(40, 64);
    ...
    // static 공격의 경우 처음 접촉했을 때 쿨타임을 주지 않으면 매 프레임당 계속해서
    // 공격한 것으로 처리되므로 해당 변수로 쿨타임을 만들게 되었습니다.
